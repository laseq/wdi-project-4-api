...
g[0] = Group.create!(name: "Max's Stag Do", description: "Max is going to be having his stag do over the Russian weekend from Monday 12th to Wednesday 14th June 2017.
...
g1e[0] = g[0].events.create!(name: "Campfire evening", description: "We'll meet up at the campsite, pitch our tents and make merry around the campfire. Make sure you bring plenty of food and drink.", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 12, 19, 0), end_time: Time.local(2017, 6, 13, 0, 0))
g1e[1] = g[0].events.create!(name: "Sleep", description: "We need to get to sleep by midnight if we want to get stuff done tomorrow.", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Whatever you sleep in", start_time: Time.local(2017, 6, 13, 0, 0), end_time: Time.local(2017, 6, 13, 8, 0))
g1e[2] = g[0].events.create!(name: "Breakfast", description: "A campfire breakfast. Make sure you bring enough food for breakfast.", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 13, 8, 0), end_time: Time.local(2017, 6, 13, 9, 30))
g1e[3] = g[0].events.create!(name: "Hiking to the canoe site", description: "The canoe site in on lake Windermere and will be about an hours walk through the hills", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 13, 10, 30), end_time: Time.local(2017, 6, 13, 11, 30))
g1e[4] = g[0].events.create!(name: "Canoeing", description: "Canoeing at Brockhole on Windermere. Their website is http://www.brockhole.co.uk/ if you want to check it out.", location: "Brockhole on Windermere, Windermere, Cumbria LA23 1LJ", dress_code: "Something you don't mind getting wet", start_time: Time.local(2017, 6, 13, 11, 30), end_time: Time.local(2017, 6, 13, 13, 30))
g1e[5] = g[0].events.create!(name: "Lunch", description: "There's a pub nearby where we'll have lunch at.", location: "Brockhole on Windermere, Windermere, Cumbria LA23 1LJ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 13, 13, 30), end_time: Time.local(2017, 6, 13, 14, 30))
g1e[6] = g[0].events.create!(name: "Archery", description: "There's an archery range nearby which I've booked and it will be super fun. Max will have an apple on his head and we need to shoot it off.", location: "Brockhole on Windermere, Windermere, Cumbria LA23 1LJ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 13, 15, 00), end_time: Time.local(2017, 6, 13, 18, 00))
g1e[7] = g[0].events.create!(name: "Drinking in town", description: "There are some pubs nearby where we'll drink at get merry at. Max will be drowning in Vodka.", location: "Brockhole on Windermere, Windermere, Cumbria LA23 1LJ", dress_code: "Anything", start_time: Time.local(2017, 6, 13, 18, 00), end_time: Time.local(2017, 6, 13, 23, 00))
g1e[8] = g[0].events.create!(name: "Travel back to camp", description: "We'll walk back to camp in the dark. Hopefully some of us will be sober enough to navigate our way back.", location: "Windermere, Cumbria LA23 1LJ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 13, 23, 00), end_time: Time.local(2017, 6, 14, 1, 00))
g1e[9] = g[0].events.create!(name: "Sleep", description: "If all goes well we should be back at camp at 1 am to get some sleep.", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Whatever", start_time: Time.local(2017, 6, 14, 1, 30), end_time: Time.local(2017, 6, 14, 9, 00))
g1e[10] = g[0].events.create!(name: "Clear up camp", description: "What goes up must come down.", location: "Thornthwaite, Keswick, Cumbria CA12 5RZ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 14, 9, 00), end_time: Time.local(2017, 6, 14, 9, 45))
g1e[11] = g[0].events.create!(name: "Breakfast", description: "We'll drive to the nearby town and get some breakfast.", location: "Keswick, Cumbria CA12 5RZ", dress_code: "Warm outdoor clothes", start_time: Time.local(2017, 6, 14, 9, 45), end_time: Time.local(2017, 6, 14, 10, 45))
g1e[12] = g[0].events.create!(name: "Paintballing", description: "We'll go paintballing in the nearby town. Max finally has the opportunity to show off his Spetznaz skills.", location: "Keswick, Cumbria CA12 5RZ", dress_code: "Something you don't mind getting dirty", start_time: Time.local(2017, 6, 14, 11, 00), end_time: Time.local(2017, 6, 14, 13, 00))
